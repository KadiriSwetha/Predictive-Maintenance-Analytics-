...
- Analyze maintenance activities and operational efficiency  
- Identify failure patterns and root causes  
- Detect high-risk engines using telemetry data  
- Reduce downtime and optimize maintenance strategies  
...
- Failure Trends  
- Top Failure Types  
- Downtime & Repair Cost Analysis  
- Top Failure-Prone Engines  
- Engine vs Failure Type Matrix  
...
- Temperature, Vibration, Operating Hours  
- Correlation Analysis (Scatter Plots)  
- High-Risk Engine Identification  
...
- Identified high failure concentration in specific regions  
- Observed impact of operating hours on engine health  
- Certain failure types contribute significantly to downtime  
- High-risk engines detected using predictive metrics  
